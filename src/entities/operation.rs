...
impl Operation {
    pub fn rev(&self) -> Self {
        ...
        match self {
            ...
            Front(ccw) => Front(!ccw),
            Back(ccw) => Back(!ccw),
            UpDouble(ccw) => UpDouble(!ccw),
            DownDouble(ccw) => DownDouble(!ccw),
            LeftDouble(ccw) => LeftDouble(!ccw),
            RightDouble(ccw) => RightDouble(!ccw),
            FrontDouble(ccw) => FrontDouble(!ccw),
            BackDouble(ccw) => BackDouble(!ccw),
